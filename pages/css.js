  ...
  render() {
    return (
      <Layout session={this.props.session}>
        ...
        <p>
          In development mode, CSS is imported in <a href="https://github.com/stackriot/nextjs-starter/blob/master/components/header.js">components/header.js</a> with "<strong>import stylesheet from &#39;../css/main.scss&#39;</strong>".
        </p>
        <p>
          This behaviour is enabled through the webpack configuration in <a href="https://github.com/stackriot/nextjs-starter/blob/master/next.config.js">next.config.js</a> (by <a href="https://github.com/davibe/next.js-css-global-style-test">Davide Bertola</a>).
        </p>
        ...
        <p>
          ...
          "<strong>/assets/{'{version}'}/main.css</strong>", which is defined in <a href="https://github.com/stackriot/nextjs-starter/blob/master/index.js">index.js</a>.
        </p>
        <p>The version string is derived from the version value in <a href="https://github.com/stackriot/nextjs-starter/blob/master/package.json">package.json</a>,
