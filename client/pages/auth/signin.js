        ...
        <div>
          <form id="signin" method="post" action="/auth/email/signin" onSubmit={this.handleSubmit}>
            ...
            <p>
              ...
              <input name="email" type="text" placeholder="name@example.com" id="email" value={this.state.email} onChange={this.handleEmailChange}/>
            </p>
            <p>
    ...
    return (
      <Layout session={this.state.session}>
        ...
        <p>
          ...
          by setting the MONGODB_URI environment variable accordingly. It works great with database providers like <a href="https://mlab.com">mLab</a>.
        </p>
        <p>
        ...
        <p>
          See <a href="https://github.com/stackriot/nextjs-starter/blob/master/server/.env.example">.env.example</a> for all the options you can use in your .env file.
        </p>
      </Layout>
    )
  }
